<%@ Page Title="" Language="VB" MasterPageFile="~/Masterpage/MasterPage.master" AutoEventWireup="false" CodeFile="Cart.aspx.vb" Inherits="Pages_Cart2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMainContent" Runat="Server">
    ...
    <table class="auto-style3" style="width: 100%">
        <tr class="auto-style5">
            ...
            <td class="auto-style4" colspan="4"><h2>Cart</h2></td>
        ...
        <tr>
            <td class="auto-style4">
                &nbsp;</td>
            <td class="auto-style4">
                <asp:Button ID="btnPlaceorder" runat="server" Text="Place Order" BackColor="#053ABF" Font-Bold="True" Font-Size="X-Large" ForeColor="White" Height="38px" Width="150px" />
            </td>
            <td>
                &nbsp;</td>
            <td>
                <h3>Total Item cost:</h3></td>
            <td>
